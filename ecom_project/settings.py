...
# USE_L10N эски версияларда колдонулат, кала берсе болот
USE_L10N = True
...
# Бул бөлүктөр сиздин файлыңыздын аягында турат:

LOGIN_REDIRECT_URL = 'list'    # Киргенден кийин 'list' барагына жиберет
LOGOUT_REDIRECT_URL = 'list'   # Чыккандан кийин 'list' барагына жиберет

# Эгер сиз сайтта медиа файлдарды (китептин сүрөттөрүн) колдонсоңуз, 
